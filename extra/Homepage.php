  ...
  <div class="wrapper">
    <nav>
      ...
      <div class="nav-content">
        <div class="logo" style="color: #fff; font-size: 28px; font-style: oblique;"><b><i>SpeakOut</i></b></div>
        <ul class="links">
          <li><a href="#"><b>Home</b></a></li>
          <li>
            <a href="#" class="desktop-link"><b>About Us </b></a>
            <input type="checkbox" id="show-services">
            <label for="show-services"><b>Register</b> <i class="fa-solid fa-angle-down"></i></label>
          </li>
          <li><a href="login.html" class="nav-login"><b>Login</b></a></li>
      ...
      <img src="C:\Users\Dhiraj\OneDrive\Desktop\student\image\b2.jfif" alt="Nature" style="width:1300px; height:600px">
      <div class="text-block">
        <h3 style="font-size: 38px; text-align: center; ">SPEAK OUT FOR CHANGE, SILENCE SOLVES NOTHING...</h3>
        <b><p style="text-align: center; font-size: 25px;">   RAISE YOUR VOICE FOR TODAY, IMPROVE TOMORROW!!!</p>
      </b>
      <button class='glowing-btn' style="margin-left: 500px; margin-top: 0px;">Register your Complaint</button>
...
<div class="container">
  ...
  <div class="footer-content">
    ...
    <ul class="list">
      ...
      <li><a  style="color: white;" href="/main/registration.html">Register</a></li>
  ...
  <div class="footer-content">
    ...
    <li><a href=""><i  style="color: white;" class="fab fa-facebook"></i></a></li>
    
    <li><a href=""><i style="color: white;" class="fab fa-twitter"></i></a></li>
    
    <li><a href=""><i  style="color: white;" class="fab fa-instagram"></i></a></li>
    
    <li><a href=""><i  style="color: white;" class="fab fa-linkedin"></i></a></li>
  </div>
</div>
<div class="bootom-bar">
  <p style="background: #000; height: 50px; color: #fff; text-align: center; padding: 20px;">&copy;2023 Your company. All rights Reserved</p>
</div>
</footer>
